...
def write(file, theme, mode):
    ...
    dictionary = {
        ...
        "colors": {
            ...
            "statusBar.debuggingBackground": surface_container_highest_hex,
            "statusBar.debuggingForeground": on_surface_hex,
            ...
            "notificationsWarningIcon.foreground": tertiary_hex,
            "notificationsInfoIcon.foreground": primary_hex,
