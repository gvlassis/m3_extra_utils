...
def write(file, theme, mode):
    ...
    dictionary = {
        ...
        "colors": {
            ...
            "editorLineNumber.foreground": secondary_container_hex,
            ...
            "editorBracketHighlight.foreground1": wheel_hex[10],
            "editorBracketHighlight.foreground2": wheel_hex[9],
            "editorBracketHighlight.foreground3": wheel_hex[7],
            "editorBracketHighlight.foreground4": wheel_hex[5],
            "editorBracketHighlight.foreground5": wheel_hex[3],
            "editorBracketHighlight.foreground6": wheel_hex[1],
            "editorBracketHighlight.unexpectedBracket.foreground": error_hex,
            ...
            "pickerGroup.border": tertiary_hex,
            "pickerGroup.foreground": tertiary_hex,
